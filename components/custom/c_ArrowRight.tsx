...
export default function ArrowRight() {
  return (
    <svg
      ...
      viewBox="0 0 256 256"
      xmlSpace="preserve"
      fill="none" // Remove fill here to avoid overriding individual path fill
      stroke="#FFFFFF" // Ensures the stroke is white
    >
      <defs></defs>
      <g
        style={{
          stroke: "#FFFFFF", // Stroke color set to white
          strokeWidth: 4, // You can adjust this if needed
